...
object JsonCodecOrOption {
  implicit def jcVersion[T: JsonCodec]: JsonCodecOrOption[T] = new JsonCodecVersion[T](implicitly[JsonCodec[T]])
  implicit def oVersion[T: JsonCodec]: JsonCodecOrOption[Option[T]] = new OptionVersion[T](implicitly[JsonCodec[T]])
}
