...
final class FlatteningIterator[+T] private [`json-impl`] (private[this] var first: Iterator[T], private[this] var xs: Vector[() => GenTraversableOnce[T]]) extends AbstractIterator[T] {
